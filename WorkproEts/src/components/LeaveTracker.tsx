    ...
    <div className="bg-white p-6 rounded-lg shadow-lg">
      ...
      <div className="w-full">
        <AreaChart width={500} height={300} data={data}>
          ...
          <YAxis />
          <Tooltip />
          <Area type="monotone" dataKey="sick" stackId="1" stroke="#8884d8" fill="#8884d8" />
          <Area type="monotone" dataKey="vacation" stackId="1" stroke="#82ca9d" fill="#82ca9d" />
          <Area type="monotone" dataKey="personal" stackId="1" stroke="#ffc658" fill="#ffc658" />
        </AreaChart>
      </div>
    </div>
  );
